...
$id = $_GET['id'];
$query = "select * from loai_hang where id_loai_hang = $id";
    ...
    <div class="page-head">
        ...
        <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
                ...
                <li class="breadcrumb-item active">Cập nhập loại hàng</li>
            </ol>
        </nav>
    </div>
    <div class="main-content container-fluid">
        <div>
            <form method="post" id="form_1" action="../controller/categories/updateCate.php">
                <div class="d-flex justify-content-center">
                    <div class="col-6">
                        <div class="form1">
                            <input type="text" name="id" value="<?php echo $loai_hang["id_loai_hang"] ?>" hidden>
                        </div>
                        <div class="form-group mb-3">
                            <label for="name_cate" class="form-label">Tên danh mục</label>
                            <input type="text" name="name" id="name" class="form-control"
                                value="<?php echo $loai_hang["ten_loai_hang"] ?>">
